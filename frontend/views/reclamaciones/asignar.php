...
<div class="container-create-reclamacion">
  ...
  <?php if ($reclamacion): ?>
    <div class="detalle-reclamacion">
      ...
      <p><strong>Fecha incidente:</strong> <?php echo htmlspecialchars($reclamacion['fecha_incidente'] ?? ''); ?></p>
      ...
      <p><strong>Fecha creación:</strong> <?php echo htmlspecialchars($reclamacion['fecha_creacion']); ?></p>
    </div>
